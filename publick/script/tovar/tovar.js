...
var TOVAR = {
  ...
  openCategoriesWood: function (category) {
    $(`.podlink-block`).removeClass('active');
    $(`#categories_wood_${category}`).addClass('active');
  },
  DESIGHN: function () {
    $("#slider-range").slider({
      range: true,
      ...
      slide: function (event, ui) {
        $("#to-price").val(ui.values[0]);
        $("#do-price").val(ui.values[1]);
      }
    });
    $("#to-price").val(0);
    $("#do-price").val(500);
